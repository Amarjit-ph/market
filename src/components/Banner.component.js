                    ...
                    <div class="h-64 rounded-md overflow-hidden bg-cover bg-center"
                        ...
                        <div class="bg-gray-900 bg-opacity-50 flex items-center h-full">
                            <div class="px-10 max-w-xl">
                                <h2 class="text-2xl text-white font-semibold">Experience Online</h2>
                                <p class="mt-2 text-gray-200">We bring you the best shopping experience online into your home. </p>
